...
public class Loadsource {
	public static HashMap<String, Template> goalMap = new HashMap<String, Template>(); // 模板名-模板 映射
...
//			mylogger.info(item.toString());
			...
			Vector<String> tokens = StringUtil.get_ngram(item.lable); //获取实体lable的tokens
